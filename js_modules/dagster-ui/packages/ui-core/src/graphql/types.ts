...
export type Query = {
  ...
  assetConditionEvaluationsOrError: Maybe<AssetConditionEvaluationRecordsOrError>;
...
export type QueryAssetConditionEvaluationsOrErrorArgs = {
  assetKey: AssetKeyInput;
  cursor?: InputMaybe<Scalars['String']>;
  limit: Scalars['Int'];
};
  ...
  return {
    ...
    assetCheckExecutions:
      overrides && overrides.hasOwnProperty('assetCheckExecutions')
        ...
        : [],
    assetConditionEvaluationsOrError:
      overrides && overrides.hasOwnProperty('assetConditionEvaluationsOrError')
        ? overrides.assetConditionEvaluationsOrError!
